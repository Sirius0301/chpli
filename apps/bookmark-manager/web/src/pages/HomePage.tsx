  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-[auto_1fr_auto] items-center mb-4 gap-4">
        <h2 className="text-lg font-bold whitespace-nowrap">全部书签</h2>
        {/* Search - centered */}
        <div className="flex items-center justify-center gap-1">
          <input
            ...
            className="px-3 py-1.5 text-sm rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 focus:ring-2 focus:ring-green-500 outline-none w-full max-w-xs"
          />
          <button
      ...
      {isLoading ? (
        ...
        <div>
          <div className="text-sm text-gray-500 mb-4">
            搜索结果：<span className="font-medium">"{activeSearch}"</span>（
