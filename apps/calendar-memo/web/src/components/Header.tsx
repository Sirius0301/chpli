      ...
      <div className="flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <div className="flex items-center gap-1">
            ...
            {/* Collapse Toggle (Desktop only, when sidebar is visible) */}
            <button 
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            <button 
              onClick={handleToday}
              className="px-2 sm:px-4 py-2 text-sm font-medium text-white bg-green-500 hover:bg-green-600 rounded-lg transition-colors shadow-sm"
            >
              {t.today}
            </button>
          ...
          <h1 className="text-lg sm:text-xl font-semibold text-gray-900 min-w-[120px] sm:min-w-[150px]">
            {getDateDisplay()}
          </h1>
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          >
            ...
            <span className="hidden md:inline">{t.newMemo}</span>
          </button>
